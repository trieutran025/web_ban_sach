...
<head>
    ...
    <link rel="stylesheet" href="../../public/admin/css/grid.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/admin/css/base.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/admin/css/style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/admin/css/responsive.css?v=<?php echo time(); ?>">
    <!-- Boxicons CDN Link -->
