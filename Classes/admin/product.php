...
class product
{
    ...
    public function insert_product($data, $files)
    {
        ...
        if ($name == '' || $price == '' || $quantity == '' || $category == '' || $supplier == '' || $description == '') {
            echo '<script language="javascript"> alert ("Không được để trống");</script> ';
        } else {
            $query = "INSERT INTO product(NameProduct, Price, QuantityProduct, ProductImg1, ProductImg2, ProductImg3, ProductImg4, ProductImg5, Descrip, IdCategory, IdSupplier, StatusProduct, TimeAdd) VALUES ('$name', '$price', '$quantity', '$Img1', '$Img2', '$Img3', '$Img4', '$Img5', '$description', '$category', '$supplier', '$status', '$time')";
