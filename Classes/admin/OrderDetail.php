...
if ($data != '')
    $sql = "SELECT * FROM `order` o JOIN `account` a ON o.IdAccount = a.IdAccount WHERE StatusOrder = '$data' ORDER BY o.DateOrder DESC";
else
    $sql =  "SELECT * FROM `order` o JOIN `account` a ON o.IdAccount = a.IdAccount ORDER BY o.DateOrder DESC";
