...
<head>
    ...
    <link rel="stylesheet" href="../../public/web/css/base.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/web/css/main.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/web/css/grid.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/web/css/bonus.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../../public/web/css/responsive.css?v=<?php echo time(); ?>">
...
<header class="header">
    <div class="grid wide" style= "flex-direction: column;">
        <!-- Nav pc -->
        <nav class="navbar hide-on-mobile-tablet">
            <ul class="navbar__list">

                <li class="navbar__item">
                    <a href="index.php" class="navbar__title--no-pointer">Trang Chủ</a>
                </li>
            </ul>
            <ul class="navbar__list">
                <?php
        ...
        <div class="header-with-search">
            ...
            <div class="header__logo">
                <a href="product.php" class="header__logo-link">
                    <img src="../../public/web/img/logo1.png" alt="Logo" class="header__logo-img">
                </a>
            </div>
                                    ...
                                    <li class="header__cart-item">
                                        ...
                                        <div class="header__cart-item-info">
                                            ...
                                            <div class="header__cart-item-body">
                                                ...
                                                <span class="header__cart-item-remove" onclick="deleteCart(<?php echo $data['idProduct']; ?>, this);">Xóa</span>
                                            </div>
                                        </div>
                                    </li>
                            <?php
